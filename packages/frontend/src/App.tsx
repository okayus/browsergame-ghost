...
import {
	type BattleCommand,
	CommandPanel,
} from "./components/battle/CommandPanel";
import {
	type DisplayMove,
	SkillSelectPanel,
} from "./components/battle/SkillSelectPanel";
...
function AuthenticatedContent() {
	...
	// ロードしたデータをゲーム状態に適用
	const applyLoadedData = useCallback((data: PlayerData) => {
		setParty(data.party);
	...
	return (
		<ErrorBoundary
			fallback={(error, reset) => (
				<ErrorScreen error={error.message} onRetry={reset} />
			)}
		>
